...
namespace EasyFinance.Server.Config
{
    public class EmailSender : IEmailSender
    {
        ...
        private SendGridMessage CreateInvitationEmail(string toEmail, string subject, string message)
        {
            ...
            var email = this.Format(this.htmlTemplateWithButton, subject, message, callbackUrl.Uri.AbsoluteUri);
        ...
        private SendGridMessage CreateConfirmationEmail(string toEmail, string subject, string message)
        {
            ...
            var email = this.Format(this.htmlTemplateConfirmEmailAndResetPassword, subject, "Please confirm your account by clicking the button below.", url.Groups[1].Value);
            return CreateDefaultEmail(toEmail, subject, email);
        }
        ...
        private SendGridMessage CreateResetPasswordEmail(string toEmail, string subject, string message)
        {
            ...
            message = Format(this.htmlTemplateConfirmEmailAndResetPassword, subject, "Please reset your password by clicking the button below.", callbackUrl.Uri.AbsoluteUri);

            return this.CreateDefaultEmail(toEmail, subject, message);
        }

        private string Format(string template, string subject, string message, string callbackUrl)
        {
            return template
        ...
        string htmlTemplateConfirmEmailAndResetPassword = @"
