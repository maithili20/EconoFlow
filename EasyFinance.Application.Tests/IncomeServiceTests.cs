...
namespace EasyFinance.Application.Tests
{
    ...
    public class IncomeServiceTests
    {
        ...
        public IncomeServiceTests()
        {
            ...
            var income1 = new IncomeBuilder().AddName("Income").AddCreatedBy(user1).AddDate(DateTime.UtcNow.AddDays(-1)).Build();
            ...
            var income2 = new IncomeBuilder().AddName("Income").AddCreatedBy(user2).AddDate(DateTime.UtcNow.AddDays(-1)).Build();
            ...
            var income3 = new IncomeBuilder().AddName("Income").AddCreatedBy(user3).AddDate(DateTime.UtcNow.AddDays(-1)).Build();
